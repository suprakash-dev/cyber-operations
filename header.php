...
<head>
    ...
    <link rel="icon" href="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/favicon.ico" type="image/vnd.microsoft.icon">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header row main-nav">
                    <div class="region region-navigation">
                        ...
                        <?php if (have_rows('menu_column', 'option')):
                            $rows = get_field('menu_column', 'option');
                            $count = count($rows);
                            $loop = 1;
                        ?>
                            <!--main-menu-->
                            <div class="main-nav__menu-container">
                                <ul class="main-nav__categories dropdown-list">
                                    <?php while (have_rows('menu_column', 'option')): the_row();
                                        $link = get_sub_field('menu_heading', 'option');
                                        if ($link):
                                            $link_url = $link['url'];
                                    ...
                                    ?>
                                            <li class="main-nav__category">
                                                <h4 class="main-nav__title">
                                                    <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>" class="main-nav__category-title-link"><?php echo esc_html($link_title); ?></a>
                                                </h4>
                                                    ...
                                                    <div class="main-nav__sub-categories">
                                                        <ul class="main-nav__sub-categories-list dropdown-sublist">
                                                            <?php while (have_rows('menu_item', 'option')): the_row();
                                                                $menulink = get_sub_field('add_menu', 'option');
                                                                if ($menulink):
                                                                    $menulink_url = $menulink['url'];
                                                                    $menulink_title = $menulink['title'];
                                                                    $menulink_target = $menulink['target'] ? $menulink['target'] : '_self';
                                                            ?>
                                                                    <li class="main-nav__sub-category">
                                                                        <a href="<?php echo esc_url($menulink_url); ?>" target="<?php echo esc_attr($menulink_target); ?>" class="main-nav__sub-category-link"><?php echo esc_html($menulink_title); ?></a>
                                                                    </li>
                                                                <?php
                                                                endif;
                                                            endwhile;
                        ...
                        <div id="accordion">
                            ...
                            ?>
                                <ul>
                                    ...
                                    ?>
                                            <li>
                                                <h4 data-toggle="collapse" data-target="#collapseOne-<?php echo $loop; ?>" aria-expanded="true" aria-controls="collapseOne">
                                                    <?php echo esc_html($link_title); ?>
                                                </h4>
                                                <div id="collapseOne-<?php echo $loop; ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                                    <ul class="main-nav__sub-categories-list dropdown-sublist">
                                                        <li class="main-nav__sub-category">
                                                            <a href="<?php echo esc_url($link_url); ?>" class="main-nav__sub-category-link ">All
                                                                <?php echo esc_html($link_title); ?>
                                                            </a>
                                                        </li>
                                                        <?php if (have_rows('menu_item', 'option')):
                            ...
                            <?php endif; ?>
                            <?php if (have_rows('mobile_menu', 'option')): ?>
                                <div class="mobile-footer-list">
                                    <div class="main-nav__members main-nav__members--mobile main-nav__members--loaded">
                                        <ul class="main-nav__members-list">
                                            <?php
                                            while (have_rows('mobile_menu', 'option')): the_row();
                                                $mobmenulink = get_sub_field('add_mobile_menus', 'option');
                                                if ($mobmenulink):
                                                    $mobmenulink_url = $mobmenulink['url'];
                                                    $mobmenulink_title = $mobmenulink['title'];
                                                    $mobmenulink_target = $mobmenulink['target'] ? $mobmenulink['target'] : '_self';
                                            ?>
                                                    <li class="main-nav__members-list-item">
                                                        <a href="<?php echo esc_url($mobmenulink_url); ?>" target="<?php echo esc_attr($mobmenulink_target); ?>" class="main-nav__members-link"><?php echo esc_html($mobmenulink_title); ?></a>
                                                    </li>
                                                <?php endif; ?>
                                            <?php endwhile; ?>
                                        </ul>
                                ...
                                <div class="mobile-social-icons">
                                    ...
                                    $instagram = get_field('instagram_link', 'option');
                                    $linkedin = get_field('linkdin_link', 'option');
                                    $mailto = get_field('mail_to_mail', 'option');
                                    ?>
                                    <?php if ($facebook): ?>
                                        <a class="share-kit__hotspot share-kit__facebook" href="<?php echo esc_url($facebook); ?>" target="_blank">
                                    ...
                                    if ($mailto):
                                    ?>
                                        <a class="share-kit__hotspot share-kit__email" href="mailto:<?php echo esc_attr($mailto); ?>" target="_blank">
